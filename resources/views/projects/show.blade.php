...
<div class="container py-3">
  ...
  <p>
    ...
    <a href="{{route('projects.tracks.create' , ['project' =>$project])}}" class="btn btn-primary">Add new track</a>
  </p>
    ...
    @foreach($project->tracks as $track)
      <a href="#" class="list-group-item list-group-item-action" style="background-color: {{ $track->color}}">
        <p class="d-flex justify-content-between align-items-center">
          ...
          <span class="badge badge-primary badge-pill">{{ $track->muted ? 'Muted' : 'Not muted' }}</span>
        </p>
